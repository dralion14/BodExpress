<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBodega.master" AutoEventWireup="true" CodeBehind="ReporteSolicitudCompra.aspx.cs" Inherits="BodExpress.ReporteSolicitudCompra" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentMain" runat="server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new BodExpress.Reportes.ReporteSolicitudCompra() %>" 
        ReportName="BodExpress.Reportes.ReporteSolicitudCompra">
    </dx:ReportViewer>
</asp:Content>
